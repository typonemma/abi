            ...
            <div class="col-sm-9">
                ...
                <form action="{{ url('admin/store') }}" method="POST">
                    @csrf
                        <div class="row">
                            <div class="col-sm-8">
                                <input name="title" class="simple-input" type="text" value="" placeholder="Title">
                                <div class="empty-space col-xs-b20"></div>
                                <input name="nomor_rekening" class="simple-input" type="text" value="" placeholder="Nomor Rekening">
                                <div class="empty-space col-xs-b20"></div>
                                <textarea name="content" class="simple-input" placeholder="Keterangan"></textarea>
                                <div class="empty-space col-xs-b20"></div>
                            </div>
                        </div>
                        <!-- @if ($errors->any())
