...
Route::group(['prefix' => 'admin'], function () {
 ...
 Route::get('users/ads/list', [
  ...
  Route::get('users/ads/create', [
    'uses' => 'AdsController@create',
    'as'   => 'admin.ads_create'
 ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');

 Route::get('users/ads/create/{id}', [
   'uses' => 'AdsController@edit',
   'as'   => 'admin.ads_edit'
])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');

Route::post('users/ads/store', [
    'uses' => 'AdsController@store',
    'as'   => 'admin.ads_store'
 ])->middleware('verifyLoginPage', 'admin', 'sufficientPermission');

 Route::post('users/ads/update/{id}', [
 ...
 //End Ads Route
  ...
  Route::get('PagesBank/store', [
      'uses' => 'PagesBankController@store',
      'as'   => 'PagesBank.store'
  ]);

  Route::post('PagesBank/create', [
      'uses' => 'PagesBankController@create',
      'as'   => 'PagesBank.create'
  ]);
