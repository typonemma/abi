...
class AdminDashboardContentController extends Controller{
  ...
  */
  public function dashboardContent(){
    ...
    if($is_vendor && Session::has('shopist_admin_user_id')){
    ...
    $dashboard['is_admin_login'] = is_admin_login();
    $dashboard['is_vendor_login'] = $is_vendor;
    $dashboard['install_info'] = install_config();
  ...
  public function sendQuickMail(){
    if( Request::isMethod('post') && Session::token() == Request::get('_token') ){
      ...
      if($validator->fails()){
        ...
        $mailData['data']    =   array('_mail_to' => Request::get('quickemailto'), '_subject' => Request::get('quickmailsubject'), '_message' => Request::get('quickmailbody'));
