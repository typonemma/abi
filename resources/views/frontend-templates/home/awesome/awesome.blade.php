                    ...
                    <div class="hover-product">
                      ...
                      <div class="single-product-bottom-section">
                        ...
                        @if( $best_sales_product['post_type'] == 'simple_product' )
                          <p>{!! price_html( get_product_price_html_by_filter(get_role_based_price_by_product_id($best_sales_product['id'], $best_sales_product['post_price'])), $selected_currency) !!}</p>
                        @elseif( $best_sales_product['post_type'] == 'configurable_product' )
                          <p>{!! get_product_variations_min_to_max_price_html($selected_currency, $best_sales_product['id']) !!}</p>
                    ...
                    <div class="hover-product">
                      ...
                      <div class="single-product-bottom-section">
                        ...
                        @if( $todays_sales_product['post_type'] == 'simple_product' )
                          <p>{!! price_html( get_product_price_html_by_filter(get_role_based_price_by_product_id($todays_sales_product['id'], $todays_sales_product['post_price'])), $selected_currency) !!}</p>
                        @elseif( $todays_sales_product['post_type'] == 'configurable_product' )
                          <p>{!! get_product_variations_min_to_max_price_html($selected_currency, $todays_sales_product['id']) !!}</p>
