  ...
  <section class="sidebar">
    <ul class="sidebar-menu">
      ...
      @if(Request::is('admin/users/ads/list') || Request::is('admin/users/ads/create'))
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-file"></i> <span>Ads</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            @if(in_array('manage_available_at',     $user_permission_list))
              @if(Request::is('admin/users/ads/list'))
                <li class="active"><a href="{{ route('admin.ads_list') }}"><i class="fa fa-table"></i> All Ads</a></li>
              @else
                <li><a href="{{ route('admin.ads_list') }}"><i class="fa fa-table"></i> All Ads</a></li>
              @endif
            @endif
            @if(in_array('manage_available_at', $user_permission_list))
              @if(Request::is('admin/users/ads/create'))
                <li class="active"><a href="{{route('admin.ads_create')}}"><i class="fa fa-plus-square-o"></i> Create Ads</a></li>
              @else
                <li><a href="{{route('admin.ads_create')}}"><i class="fa fa-plus-square-o"></i> Create Ads</a></li>
              @endif
            @endif
          </ul>
        </li>
