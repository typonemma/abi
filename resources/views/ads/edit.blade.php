...
<form class="form-horizontal" method="post" action="{{route('admin.ads_update',$ads->id)}}" enctype="multipart/form-data">
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-sm-8">
            <input type="text" placeholder="Name" class="form-control" value="{{$ads->title}}" id="name" name="name">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-sm-8">
            <input type="text" placeholder="Link / Url" class="form-control" value="{{$ads->url}}" id="url" name="url">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-sm-8">
            <input type="date" placeholder="Start Date" class="form-control" value="{{$ads->start_date}}" id="start_date" name="start_date">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="row">
          ...
          <div class="col-sm-8">
            <input type="date" placeholder="End Date" class="form-control" value="{{$ads->end_date}}" id="end_date" name="end_date">
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            <select name="status" class="form-control" id="">
                <option value="0" {{$ads->status == '0'?'selected':''}}>INACTIVE</option>
                <option value="1" {{$ads->status == '1'?'selected':''}}>ACTIVE</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <div class="uploaded-product-image">
            <div class="product-sample-img"><img class="upload-icon img-responsive" src="{{$ads->image != null ?$ads->image:default_upload_sample_img_src()}}"></div>
