  ...
  <div class="row">
    <div class="col-md-8">
      <div class="box box-solid">
        ...
        <div class="box-body">
          <input name="name" type="text" placeholder="Compatibility name" class="form-control" name="compatibility_name" id="eb_compatibility_name" value="{{ $compatibility->name }}">
        </div>
      </div>
      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select class="form-control select2" name="product" style="width: 100%;" value="{{ $compatibility->product_id }}">
        ...
        <div class="box box-solid">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select class="form-control select2" name="type" style="width: 100%;" value="{{ $compatibility->type }}">
