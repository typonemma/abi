            ...
            <div class="box-body">
              <div class="form-group">
                <div class="row">  
                  ...
                  <div class="col-sm-8">
                    <input type="number" class="form-control" id="min_filter_price" name="min_filter_price" value="{{ $appearance_settings['general']['filter_price_min'] }}"/>
                  </div>
                </div>  
              </div>
              ...
              <div class="form-group">
                <div class="row">    
                  ...
                  <div class="col-sm-8">
                    <input type="number" class="form-control" id="max_filter_price" name="max_filter_price" value="{{ $appearance_settings['general']['filter_price_max'] }}"/>
                  </div>
                </div>  
              </div>
              ...
              <div class="form-group">
                <div class="row">    
                  ...
                  <div class="col-sm-8">
                    @if(count( $appearance_settings) &&  $appearance_settings['general']['custom_css'] == true)
              ...
              <div class="general-custom-css-panel" {{ $style_general }}>
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="general_settings_body_bg" name="general_settings_body_bg" value="{{  $appearance_settings['general']['body_bg_color'] }}"/>
                    </div>
                  </div>  
                </div>
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="sidebar_panel_bg_color" name="sidebar_panel_bg_color" value="{{  $appearance_settings['general']['sidebar_panel_bg_color'] }}"/>
                    </div>
                  </div>  
                </div>
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="sidebar_panel_title_text_color" name="sidebar_panel_title_text_color" value="{{ $appearance_settings['general']['sidebar_panel_title_text_color'] }}"/>
                    </div>
                  </div>  
                </div>
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="sidebar_panel_title_text_bottom_border" name="sidebar_panel_title_text_bottom_border" value="{{  $appearance_settings['general']['sidebar_panel_title_text_bottom_border_color'] }}"/>
                    </div>
                  </div>  
                </div>
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="sidebar_panel_content_text_color" name="sidebar_panel_content_text_color" value="{{  $appearance_settings['general']['sidebar_panel_content_text_color'] }}"/>
                    </div>
                  </div>  
                </div>
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="product_box_bg_color" name="product_box_bg_color" value="{{  $appearance_settings['general']['product_box_bg_color'] }}"/>
                    </div>
                  </div>  
                </div>
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="product_box_border_color" name="product_box_border_color" value="{{  $appearance_settings['general']['product_box_border_color'] }}"/>
                    </div>
                  </div>  
                </div>
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="product_box_content_color" name="product_box_content_color" value="{{  $appearance_settings['general']['product_box_text_color'] }}"/>
                    </div>
                  </div>  
                </div>  
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="product_box_btn_bg_color" name="product_box_btn_bg_color" value="{{  $appearance_settings['general']['product_box_btn_bg_color'] }}"/>
                    </div>
                  </div>  
                </div> 
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="btn_text_color" name="btn_text_color" value="{{ $appearance_settings['general']['btn_text_color'] }}"/>
                    </div>
                  </div>  
                </div> 
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="product_box_btn_hover_color" name="product_box_btn_hover_color" value="{{  $appearance_settings['general']['product_box_btn_hover_color'] }}"/>
                    </div>
                  </div>  
                </div>
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="btn_hover_text_color" name="btn_hover_text_color" value="{{  $appearance_settings['general']['btn_hover_text_color'] }}"/>
                    </div>
                  </div>  
                </div> 
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="selected_menu_border_color" name="selected_menu_border_color" value="{{  $appearance_settings['general']['selected_menu_border_color'] }}"/>
                    </div>
                  </div>  
                </div> 
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="pages_content_title_border_color" name="pages_content_title_border_color" value="{{  $appearance_settings['general']['pages_content_title_border_color'] }}"/>
                    </div>
                  </div>  
                </div> 
              </div>  
...
<!--              <div class="form-group">
              ...
              <div class="form-group">
                <div class="row">    
                  ...
                  <div class="col-sm-8">
                    @if(count( $appearance_settings) &&  $appearance_settings['header_details']['slider_visibility'] == true)
              ...
              <div class="form-group">
                <div class="row">    
                  ...
                  <div class="col-sm-8">
                    @if(count( $appearance_settings) &&  $appearance_settings['header_details']['custom_css'] == true)
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <div class="row">
                        <div class="col-sm-6">
                          <input type="text" class="color form-control" id="header_top_bg_start_color" name="header_top_bg_start_color" value="{{  $appearance_settings['header_details']['header_top_gradient_start_color'] }}"/>&nbsp;( {!! trans('admin.gradient_start_color_label') !!} )
                        </div>
                        <div class="col-sm-6">
                          <input type="text" class="color form-control" id="header_top_bg_end_color" name="header_top_bg_end_color" value="{{  $appearance_settings['header_details']['header_top_gradient_end_color'] }}"/>&nbsp;( {!! trans('admin.gradient_end_color_label') !!} )
                        </div>
                      </div>
                    </div>
                  </div>  
...
<!--                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="header_text_color" name="header_text_color" value="{{  $appearance_settings['header_details']['header_text_color'] }}"/>
                    </div>
                  </div>  
                </div>
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="header_text_hover_color" name="header_text_hover_color" value="{{  $appearance_settings['header_details']['header_text_hover_color'] }}"/>
                    </div>
                  </div>  
                </div>
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input id="change_header_text_size" type="text" name="change_header_text_size" data-name="header_text_size" value="{{  $appearance_settings['header_details']['header_text_size'] }}">
                    </div>
                  </div>  
                </div>
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="header_selected_menu_bg_color" name="header_selected_menu_bg_color" value="{{  $appearance_settings['header_details']['header_selected_menu_bg_color'] }}"/>
                    </div>
                  </div>  
                </div>
                <div class="form-group">
                  <div class="row">    
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="color form-control" id="header_selected_menu_text_color" name="header_selected_menu_text_color" value="{{  $appearance_settings['header_details']['header_selected_menu_text_color'] }}"/>
                    </div>
                  </div>  
                </div>
              </div>  
          ...
          <input type="hidden" name="header_text_size" id="header_text_size" value="{{  $appearance_settings['header_details']['header_text_size'] }}">
          <input type="hidden" name="sidebar_panel_title_text_size" id="sidebar_panel_title_text_size" value="{{  $appearance_settings['general']['sidebar_panel_title_text_font_size'] }}">
          <input type="hidden" name="sidebar_panel_content_text_size" id="sidebar_panel_content_text_size" value="{{  $appearance_settings['general']['sidebar_panel_content_text_font_size'] }}">
          <input type="hidden" name="product_box_content_text_size" id="product_box_content_text_size" value="{{  $appearance_settings['general']['product_box_text_font_size'] }}">
        </form>  
      </div>
